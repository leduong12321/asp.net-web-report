...
namespace ReportAPI.Controllers
{
    ...
    public class UserController : ApiController
    {
        User[] user = new User[]
        {
            ...
            new User { Id = 2, Name = "KCS", UserName = "kcs", Password = "kcs", Description = "Quyền truy cập hạn chế", Role = 1 },
            new User { Id = 3, Name = "CNC", UserName = "cnc", Password = "cnc", Description = "Quyền truy cập hạn chế", Role = 2 },
            new User { Id = 4, Name = "TSC", UserName = "tsc", Password = "tsc", Description = "Quyền truy cập hạn chế", Role = 3 },
        };
        public dynamic Get()
        {
            return user;
